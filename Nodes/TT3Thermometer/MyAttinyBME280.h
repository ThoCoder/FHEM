...
#ifndef MyAttinyBME280_h
#define MyAttinyBME280_h
...
class MyAttinyBME280
{
  public:
    MyAttinyBME280(byte, byte, byte);
    bool isReady(void);
    void init();
    void startSingleMeas(void);
    int32_t readTemp10(void);
	int32_t readPress10(void);
	int32_t readHumidity10(void);
	void readAll(int16_t&, int16_t&, int16_t&);
    void setMode(byte);
...
private:
	...
	int32_t calcTemp10(void);
	int32_t calcPress10(void);
	int32_t calcPress10_i32(void);
	int32_t calcHumidity10(void);
